            ...
            <svg width="60px" height="60px" viewBox="0 0 443 271" style={{ fillRule: "evenod", clipRule: "evenodd", strokeLinejoin: "round", strokeMiterlimit: 2 }}>
                <g transform="matrix(1,0,0,1,-78.3058,-164.017)">
                    <g id="Layer-1">
                        ...
                        <g transform="matrix(-38.0649,77.6524,77.6524,38.0649,258.701,244.714)">
                        ...
                        <g transform="matrix(106.807,-78.9149,-78.9149,-106.807,235.154,285.349)">
                        ...
                        <g transform="matrix(97.417,0,0,-97.417,192.862,279.647)">
                            <path d="M0.495,0.551C0.488,0.55 0.48,0.548 0.474,0.544L0.043,0.296L0.508,-0.551C0.514,-0.55 0.52,-0.548 0.526,-0.545L0.959,-0.295C0.972,-0.287 0.981,-0.274 0.984,-0.259L0.51,0.55C0.506,0.551 0.503,0.551 0.499,0.551C0.498,0.551 0.496,0.551 0.495,0.551Z" style={{ fill: "url(#_Linear3)", fillRule: "nonzero" }} />
                        </g>
                        <g transform="matrix(97.417,0,0,-97.417,192.862,320.031)">
                            <clipPath id="_clip4">
                                <path d="M0.474,0.959L0.041,0.709C0.025,0.7 0.015,0.683 0.015,0.664L0.015,0.165C0.015,0.146 0.025,0.129 0.041,0.119L0.474,-0.13C0.49,-0.14 0.51,-0.14 0.526,-0.13L0.959,0.119C0.975,0.129 0.985,0.146 0.985,0.165L0.985,0.664C0.985,0.683 0.975,0.7 0.959,0.709L0.526,0.959C0.518,0.964 0.509,0.966 0.5,0.966C0.491,0.966 0.482,0.964 0.474,0.959Z" clipRule="nonzero" />
                            </clipPath>
                            <g clipPath="url(#_clip4)">
                                <path d="M0.96,0.119L0.527,-0.13C0.521,-0.134 0.514,-0.136 0.508,-0.137L0.516,-0.153L0.997,0.126L0.997,0.132L0.985,0.153C0.982,0.139 0.972,0.127 0.96,0.119Z" style={{ fill: "url(#_Linear5)", fillRule: "nonzero" }} />
                            </g>
                        </g>
                        <g transform="matrix(-60.0806,122.564,122.564,60.0806,304.472,242.412)">
                            <clipPath id="_clip6">
                                <path d="M0.107,-0.481L0.403,-0.68C0.414,-0.688 0.428,-0.689 0.44,-0.683L0.76,-0.526C0.772,-0.52 0.78,-0.508 0.781,-0.495L0.805,-0.139C0.806,-0.126 0.8,-0.113 0.789,-0.106L0.493,0.093C0.482,0.1 0.468,0.101 0.456,0.095L0.136,-0.062C0.124,-0.067 0.116,-0.079 0.115,-0.092L0.091,-0.448C0.09,-0.455 0.092,-0.461 0.094,-0.467C0.097,-0.473 0.102,-0.478 0.107,-0.481Z" clipRule="nonzero" />
                            </clipPath>
                            <g clipPath="url(#_clip6)">
                                <path d="M0.493,0.094L0.789,-0.105C0.793,-0.108 0.796,-0.112 0.799,-0.116L0.806,-0.105L0.477,0.116L0.472,0.114L0.463,0.1C0.473,0.102 0.484,0.099 0.493,0.094Z" style={{ fill: "url(#_Linear7)", fillRule: "nonzero" }} />
                            </g>
                        </g>
                    </g>
                </g>
                <defs>
                    <linearGradient id="_Linear1" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,5.55112e-17,5.55112e-17,-1,0,7.12087e-06)"><stop offset="0" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /><stop offset="1" style={{ stopColor: "rgb(130,161,120)", stopOpacity: 1 }} /></linearGradient>
                    <linearGradient id="_Linear2" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,0,0,-1,0,-4.30748e-05)"><stop offset="0" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /><stop offset="0.14" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /><stop offset="0.91" style={{ stopColor: "rgb(154,180,142)", stopOpacity: 1 }} /><stop offset="1" style={{ stopColor: "rgb(154,180,142)", stopOpacity: 1 }} /></linearGradient>
                    <linearGradient id="_Linear3" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,0,0,-1,0,-4.14671e-05)"><stop offset="0" style={{ stopColor: "rgb(154,180,142)", stopOpacity: 1 }} /><stop offset="0.09" style={{ stopColor: "rgb(154,180,142)", stopOpacity: 1 }} /><stop offset="0.86" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /><stop offset="1" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /></linearGradient>
                    <linearGradient id="_Linear5" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,0,0,-1,0,-6.14472e-06)"><stop offset="0" style={{ stopColor: "rgb(154,180,142)", stopOpacity: 1 }} /><stop offset="0.09" style={{ stopColor: "rgb(154,180,142)", stopOpacity: 1 }} /><stop offset="0.86" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /><stop offset="1" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /></linearGradient>
                    <linearGradient id="_Linear7" x1="0" y1="0" x2="1" y2="0" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,5.55112e-17,5.55112e-17,-1,0,6.20936e-08)"><stop offset="0" style={{ stopColor: "rgb(105,126,102)", stopOpacity: 1 }} /><stop offset="1" style={{ stopColor: "rgb(130,161,120)", stopOpacity: 1 }} /></linearGradient>
                </defs>
            </svg>
        </>
    )
